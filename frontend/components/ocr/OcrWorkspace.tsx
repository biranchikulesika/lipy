...
export function OcrWorkspace() {
	...
	return (
		<main className="relative mx-auto flex h-[calc(100dvh-4.5rem)] max-w-375 flex-col gap-3 box-border overflow-hidden px-3 pb-2 pt-14 sm:px-4 lg:gap-4 lg:px-8 lg:py-6 lg:p-8 lg:justify-center">
